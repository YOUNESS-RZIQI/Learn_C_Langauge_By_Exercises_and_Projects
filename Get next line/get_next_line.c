...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/11/15 05:53:01 by yrziqi            #+#    #+#             */
/*   Updated: 2025/11/16 08:21:55 by yrziqi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_next_line(int fd)
{
	...
	if (read_until_newline(fd, &leftover) == -1 || !leftover)
		return (NULL);
	line = get_line_from_leftover(&leftover);
	if (line)
		return (line);
